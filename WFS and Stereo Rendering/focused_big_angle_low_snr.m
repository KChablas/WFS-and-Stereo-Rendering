snr = LOW_SNR;
output_path = 'Sounds/ExperimentSounds/3.Experiment_WFS_big_angle_low_SNR/';
filt_name = '../SpectralAnalysis/filter3.mat';
...
speech_list = dir(fullfile('Sounds/speeches/3.WFS_big_angle_low_SNR', '*.wav'));
...
for i = 1:height(speech_list)
    ...
    noise_dir = string(sprintf('Sounds/Resto_snippets/resto%i', i+20));
