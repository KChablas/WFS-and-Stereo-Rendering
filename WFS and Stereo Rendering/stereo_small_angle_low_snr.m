...
output_path = 'Sounds/ExperimentSounds/8.Experiment_stereo_small_angle_low_SNR/';

speech_list = dir(fullfile('Sounds/speeches/8.stereo_small_angle_low_SNR', '*.wav'));

for i = 1:height(speech_list)
    noise_file = string(sprintf('Sounds/Resto_snippets/resto%i/ch01_%i.wav', i+10, i+10));
