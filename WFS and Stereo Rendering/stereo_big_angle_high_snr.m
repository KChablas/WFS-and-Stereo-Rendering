...
output_path = 'Sounds/ExperimentSounds/5.Experiment_stereo_big_angle_high_SNR/';

speech_list = dir(fullfile('Sounds/speeches/5.stereo_big_angle_high_SNR', '*.wav'));

for i = 1:height(speech_list)
    noise_file = string(sprintf('Sounds/Resto_snippets/resto%i/ch01_%i.wav', i+40, i+40));
