snr = LOW_SNR;
output_path = 'Sounds/ExperimentSounds/4.Experiment_WFS_small_angle_low_SNR/';
filt_name = '../SpectralAnalysis/filter4.mat';
...
speech_list = dir(fullfile('Sounds/speeches/4.WFS_small_angle_low_SNR', '*.wav'));
...
for i = 1:height(speech_list)
    ...
    noise_dir = string(sprintf('Sounds/Resto_snippets/resto%i', i+30));
